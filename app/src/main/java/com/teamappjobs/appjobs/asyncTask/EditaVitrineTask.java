 ...
 */
public class EditaVitrineTask extends AsyncTask {

    private final String url = "http://www.4runnerapp.com.br/AppJobs/Ctrl/cadastra_vitrine_json.php";
    private final String method = "edita_vitrine-json";
    ...
    public EditaVitrineTask(Activity activity, Vitrine vitrine, Bitmap imagemPerfil) {
