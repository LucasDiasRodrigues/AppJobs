 ...
 */
public class EditaPromocaoTask extends AsyncTask {

    private final String url = "http://www.4runnerapp.com.br/AppJobs/Ctrl/cadastra_promocao_json.php";
    private final String method = "edita_promocao-json";
    ...
    public EditaPromocaoTask(Activity activity, Promocao promocao, Bitmap imagem) {
    ...
    protected Object doInBackground(Object[] params) {
        ...
        } else if(imagem == null && (!promocao.getFoto().equals(""))) {
            promocao.setFoto("naoalterada");
        } else{
            promocao.setFoto("");
        }
