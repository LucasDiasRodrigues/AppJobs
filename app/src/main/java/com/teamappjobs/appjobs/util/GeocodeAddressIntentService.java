...
/**
 * Created by Mônica on 31/05/2017.
 */
...
public class GeocodeAddressIntentService extends IntentService {
    ...
    public static final String PACKAGE_NAME = "com.teamappjobs.appjobs";
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        ...
        bundle.putString(RESULT_DATA_KEY, address.getLocality() + " - " +address.getAdminArea());
